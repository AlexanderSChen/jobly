...
describe("PATCH /users/:username", () => {
  ...
  test("Unauthorized if not the same user", async function() {
    const resp = await request(app)
        .patch(`/users/u1`)
        .send({
          firstName: "New",
...
describe("POST /users/:username/jobs/:id", function() {
  ...
  test("Not Found for no username found", async function() {
    const resp = await request(app)
  ...
  test("Not Found for no job found", async function() {
    const resp = await request(app)
